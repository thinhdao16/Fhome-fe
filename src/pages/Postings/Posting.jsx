    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://fhome2-be.vercel.app/getAllFavourite",
          {
            headers: {
        ...
        const responsePost = await axios.get(
          "https://fhome2-be.vercel.app/posts/",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${userPosting.data.accessToken}`,
        ...
        const responsePostComment = await axios.get(
          "https://fhome2-be.vercel.app/allComment/",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${userPosting.data.accessToken}`,
...
console.log(id)
    if (confirmed) {
      axios
        .put(
          `https://fhome2-be.vercel.app/posts/confirm/${id}`,
          {
            status: "pending",
          },
          {
  ...
  function handlePostRejct(event, id) {
    ...
    if (window.confirm("Bạn có chắc muốn reject post này không?")) {
      axios
        .delete(`https://fhome2-be.vercel.app/posts/delete/${id}`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${userPosting.data.accessToken}`,
          },
...
//   axios.get("https://fhome2-be.vercel.app/getBuildings"),
//   axios.get("https://fhome2-be.vercel.app/getAllStatus"),
//   axios.get("https://fhome2-be.vercel.app/getRooms"),
//   axios.get("https://fhome2-be.vercel.app/getAllUsers"),
// ]);
...
// // Get favorites
// const response = await axios.get(
//   "https://fhome2-be.vercel.app/getFavouriteByUser",
//   {
//     headers: {
//       "Content-Type": "application/json",
//       Authorization: `Bearer ${userPosting.data.accessToken}`,
